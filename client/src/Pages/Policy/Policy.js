    ...
    <div className="container-fluid" style={{ marginTop: "70px" }}>
      <div className="row">
        <div className="col-md-12">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Well-Travelled Explorations, LLC,
                365 H St, Blaine, WA 98230.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Next Up City Guide,
                accessible from{" "}
                <a
                  href="https://www.nextup.city"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://www.nextup.city
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>By email: admin@nextup.city</li>
          </ul>
        </div>
      </div>
    </div>
